...
import { STAGE5_SEGMENTS, STAGE5_JOGS, STAGE5_ROOFS } from '../data/stage5Walls.js'

// Guard-wall container for the Stage5 -> Stage6 corridor — see
// data/stage5Walls.js for the full layout (a normal-width lane, a narrow
// lane spanning Ground.026/.027 and the floor gap between them, and
// Ground.028's wide lane — no door fills needed, both boundary panels
// share the same height). Same studded material/colors and size-keyed
// material cache as components/Stage3Walls.jsx/Stage4Walls.jsx.
const LIGHT = '#9398a0'
const DARK = '#9398a0'
const CELL = 1
...
export default function Stage5Walls() {
  const pieces = useMemo(() => [...STAGE5_SEGMENTS, ...STAGE5_JOGS, ...STAGE5_ROOFS], [])
