...
import { STAGE7_SEGMENTS, STAGE7_JOGS, STAGE7_ROOFS } from '../data/stage7Walls.js'

// Guard-wall container for the Stage7 -> Stage8 corridor — see
// data/stage7Walls.js for the full layout (a wide perimeter room around
// the Ground.036-045 rotated pillar cluster, then Ground.046's wide lane
// — no door fills needed, both boundary panels share the same height).
// Same studded material/colors and size-keyed material cache as
// components/Stage3Walls.jsx through Stage6Walls.jsx.
const LIGHT = '#9398a0'
const DARK = '#9398a0'
const CELL = 1
...
export default function Stage7Walls() {
  const pieces = useMemo(() => [...STAGE7_SEGMENTS, ...STAGE7_JOGS, ...STAGE7_ROOFS], [])
