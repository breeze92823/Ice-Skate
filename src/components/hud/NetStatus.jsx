...
// never per frame. This project has no server (systems/net.js's stub),
// so netState.status stays 'idle' and describe() returns null — this
// renders nothing today, matching a real deploy's "connected, say
