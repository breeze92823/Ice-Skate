...
// renders while active — a guest with the SDK blocked still sees who they
// are — and it has no interactive controls, so it stays pointer-events-none.
// Event-driven via useAuth(); never re-renders per frame.
